...
class Element implements LayoutCanvasElementInterface, \JsonSerializable {
  ...
  /** @var \Drupal\cohesion\Plugin\LayoutCanvas\Element|\Drupal\cohesion\Plugin\LayoutCanvas\LayoutCanvas $parent */
  protected $parent;

  /** @var \Drupal\cohesion\Plugin\LayoutCanvas\Element[] $children */
  protected $children = [];
   ...
   * @param \Drupal\cohesion\Plugin\LayoutCanvas\Element|\Drupal\cohesion\Plugin\LayoutCanvas\LayoutCanvas $parent
  ...
  /**
   * @return \Drupal\cohesion\Plugin\LayoutCanvas\ElementModel|NULL
   */
