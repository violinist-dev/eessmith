...
/**
 * Class CohesionLayoutRebuildTrait
 *
 * @package Drupal\cohesion_layout_builder\Controller
 */
trait CohesionLayoutRebuildTrait {
  ...
  protected function rebuildLayout(SectionStorageInterface $section_storage) {
    ...
    $layout_controller = $this->classResolver->getInstanceFromDefinition(CohesionLayoutBuilderController::class);
