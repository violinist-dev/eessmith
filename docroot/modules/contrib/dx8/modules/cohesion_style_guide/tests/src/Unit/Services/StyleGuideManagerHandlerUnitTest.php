...
use Drupal\Tests\cohesion\Unit\Controller\MachineNameStorageMock;
 ...
 */
class StyleGuideManagerHandlerMock extends StyleGuideManagerHandler {
}
...
class StyleGuideManagerHandlerUnitTest extends UnitTestCase {
  ...
  public function setUp() {
    ...
    $this->mockUnit = new StyleGuideManagerHandlerMock($entity_type_manager, $entity_repository, $usage_update_manager, $theme_handler);
  }
