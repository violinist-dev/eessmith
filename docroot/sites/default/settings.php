 ...
 * @endcode
 */
$settings['hash_salt'] = '_M2g0zJtbXdJ5NrMTvMynI6DE9312Am4M7K8kVXLKGIa7bj4Dq-v3fr1s9byIYWNQgXlxK-OWw';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eessmith_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eessmith_dev_default.inc';
}
// </DDSETTINGS>
